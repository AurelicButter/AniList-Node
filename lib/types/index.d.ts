...
declare class Anilist {
	 ...
	 */
	search(type: 'anime' | 'manga' | 'character' | 'staff' | 'studio' | 'user', term: string, page?: number, amount?: number): Promise<SearchEntry>;
}
...
declare class Search {
	 ...
	 * @since 1.7.0
	 */
	character(term: string, page?: number, amount?: number): Promise<SearchEntry>;
	 ...
	 * @since 1.7.0
	 */
	studio(term: string, page?: number, amount?: number): Promise<SearchEntry>;
	 ...
	 * @since 1.7.0
	 */
	staff(term: string, page?: number, amount?: number): Promise<SearchEntry>;
	 ...
	 * @since 1.7.0
	 */
	user(term: string, page?: number, amount?: number): Promise<SearchEntry>;
	 ...
	 * @since 1.7.0
	 */
	anime(term?: string, filter?: MediaFilterTypes, page?: number, amount?: number): Promise<SearchEntry>;
	 ...
	 * @since 1.7.0
	 */
	manga(term?: string, filter?: MediaFilterTypes, page?: number, amount?: number): Promise<SearchEntry>;
...
declare interface BaseRelation {
	id: number,
	name: string
}
...
declare interface PersonRelation extends BaseRelation {}

declare interface SearchEntry {
	pageInfo: PageInfo,
	media: [{
		id: number,
		title: MediaTitle,
...
declare interface StudioRelation extends BaseRelation {
...
declare interface UserFavourites {
	...
	staff: PersonRelation[],
	studios: BaseRelation[]
}

declare interface UserProfile extends BaseRelation {
	about: string,
	avatar: Media,
	bannerImage: string,
	isFollowing: boolean,
