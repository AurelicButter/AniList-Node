module.exports = {
	...
	TextActivityQuery: `id userId type text createdAt replies { id text likeCount }
        isLocked isSubscribed isLiked likes { id name }`,
	MessageActivityQuery: `id recipientId type message createdAt replies { id text likeCount }
        userId:messengerId isPrivate isLocked isSubscribed isLiked likes { id name }`,
	ListActivityQuery: ` id userId status type progress
