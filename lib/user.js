//Queries for each specific function. Stored here to remove redundant queries.
...
unreadNotificationCount siteUrl donatorTier donatorBadge moderatorStatus updatedAt`;
...
class User {
	...
	getAuthorized() {
		...
		return this.util.send(`query{Viewer{${profileQuery}}}`, {});
	}
}
