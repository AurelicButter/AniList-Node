...
class Lists {
	 ...
	 * @param {Object} options - Values to save with.
	 * @returns A media object showing the current values of the entry. Should match
	 * the options object.
	 * @since 1.13.0
	 */
	async addEntry(id, options) {
		...
		query += `mediaId status score progress progressVolumes repeat priority private 
		hiddenFromStatusLists customLists startedAt completedAt notes advancedScores }}`;
