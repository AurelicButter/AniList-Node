 ...
 * @property { MediaStatus } media.status - The media's status (Used for anime and manga searches only)
 * @property { MediaFormat } media.format - The media's format (Used for anime and manga searches only)
