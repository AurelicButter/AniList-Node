 ...
 * @enum
 * @property { Number } id - The id of the activity
 * @property { Number } userId - The user id of the activity
 ...
 * @enum
 * @property { Number } id - The id of the activity
 * @property { Number } userId - The sender's AniList ID
 * @property { Number } recipientId - The id of the user receiving the message
